 ...
 *  用户所有订单
 */
class UserOrder extends AbsUserManage
{
    public $permission = [
        'execute' => 1,
        'excel' => 2,
    ...
    {
        return $this->user->permission['508']??0;
    }
    ...
    public function excel(Request $request)
    {
        ...
        try {
            ...
            DB::table('admin_log')->insert(['admin_id' => $this->user->id, 'log' => "用户管理，用户所有订单导出", 'type' => 5, 'ip' => $request->getClientIp()]);
