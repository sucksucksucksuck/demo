...
import * as agencyAction from '../../../../action/user_withdrawal/unpassList'
...
const head = [
    ...
    {"text": "实际金额", "key": "asual"},
    {"text": "描述", "key": "status", className: "w100"},
    {"text": "状态", "key": "status", className: "w100"},
]
const module = 100
class UnPassList extends AbsTabContent {
    constructor(props) {
        super(props, module)
        //通过属性传递state过来
        this.state = props['unPassList']
    }
...
export default connect(({unPassList}) => ({unPassList}))(UnPassList)