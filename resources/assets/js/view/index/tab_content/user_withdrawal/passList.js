...
import * as agencyAction from '../../../../action/user_withdrawal/passList'
...
const module = 100
class PassList extends AbsTabContent {
    constructor(props) {
        super(props, module)
        //通过属性传递state过来
        this.state = props['passList']
    }
...
export default connect(({passList}) => ({passList}))(PassList)