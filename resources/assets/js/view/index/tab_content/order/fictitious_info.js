...
const module = 207;
class OrderFictitiousInfo extends React.Component {
    constructor(props) {
        super(props);
        //通过属性传递state过来
    ...
    componentDidMount() {  //render前
        orderAction.getFictitiousInfo({id: this.props.extend});
    }
    ...
    onSubmit() {
        utilAction.confirm("是否确认修改?", () => {
            orderAction.setFictitiousInfo(this.refs['form'].getValue(this.state.info));
            return true;
        });
    }
            ...
            <div className="order-form">
                ...
                <div className="wrap">
                    <Form ref="form"
                        ...
                        <div className="lucky">{this.luckyCode()}</div>
...
export default connect(({orderFictitiousInfo}) => ({orderFictitiousInfo}))(OrderFictitiousInfo);
